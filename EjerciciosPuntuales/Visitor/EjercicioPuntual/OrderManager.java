...
public class OrderManager extends JFrame {
  ...
  public static final String CHINESE_ORDER = "Chinese Order";
...
class ButtonHandler implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals(OrderManager.CREATE_ORDER)
      ...
      //Create the order
      Order order = orderFactory.createOrder(orderType, dblOrderAmount,
                    dblTax, dblSH);

      OrderDirector director = new OrderDirector(order);
