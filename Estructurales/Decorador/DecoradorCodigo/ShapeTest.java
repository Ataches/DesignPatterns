...
public class ShapeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------------------");
        Shape circle = new Circle(4,true);        
        circle.draw();
        circle.areaCalc();
        
        Shape rectangle = new Rectangle(2,6,true);
        rectangle.draw();
        rectangle.areaCalc();
        ...
        new LineThiknessDecorator(new Circle(4,true), 1.0d), LineStyle.DASH), Color.BLUE), Color.RED);
        circle1.draw();
        circle1.areaCalc();
        ...
        System.out.println("------------------------------------------------------------------");
        Circle c = new Circle(9,true);
        LineThiknessDecorator lt = new LineThiknessDecorator(c, 3.0d);
        ...
        System.out.println("------------------------------------------------------------------");
        Shape circle2 = new FillColorDecorator(new LineColorDecorator(new Circle(11,true), Color.BLACK), Color.GREEN);
        circle2.draw();
        circle2.areaCalc();
        ...
        System.out.println("------------------------------------------------------------------");
        Shape rectangle1 = new FillColorDecorator(new LineColorDecorator(new Rectangle(5,10,false), Color.RED), Color.YELLOW);
        rectangle1.draw();
        rectangle1.areaCalc();
	}
}
